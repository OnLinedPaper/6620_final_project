...
<body>
    <?php
        ...
        if(isset($_POST['submit'])){
            ...
            echo "<b>user relations updated</b><br />";
        }
        ...
        if(isset($_GET['id']) and $_GET['id'] != ""){
            ...
            do{
                echo "<br /><a href=\"".str_replace(' ', '+', $result_row[4])."\" download>".$result_row[2]." (download)"."</a> : <a href=\"media.php?id=$result_row[2]\" target=\"_blank\">".$result_row[3]."</a><br />";
